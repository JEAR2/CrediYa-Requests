...
class RequestUseCaseTest {
    ...
    private LoanTypeRepository loanTypeRepositor;
    ...
    void setUp() {
        ...
        loanTypeRepositor = Mockito.mock(LoanTypeRepository.class);
        userGateway = Mockito.mock(UserGateway.class);
        requestUseCase = new RequestUseCase(requestRepository,stateRepository,loanTypeRepositor,userGateway);
    }
